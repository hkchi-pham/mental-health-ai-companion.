"""
SCRIPT DISABLED - Requires GPU/CUDA for SentenceTransformer
Uncomment the code below when GPU is available.
Currently using OpenAI/Gemini API instead.
"""
...
print("This script is disabled. GPU/SentenceTransformer not available.")

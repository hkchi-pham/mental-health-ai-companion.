...
Uses OpenAI GPT models for emotion analysis and response generation.
"""
...
class OpenAIService(BaseAIService):
    ...
    def __init__(self):
        ...
        self._model = os.getenv("OPENAI_MODEL", "gpt-4o-2024-08-06")
        self._client = None
...
"""
    ...
    def _keyword_emotion_detection(self, message: str) -> Optional[EmotionAnalysis]:
        ...
        return None  # No keyword match, use GPT

...
def init_garden_tables() -> None:
    """Create the garden_items / garden_decorations / garden_badges tables if they
    do not already exist. Idempotent (CREATE TABLE IF NOT EXISTS): a no-op when the
    tables exist, never drops/alters existing tables or data. Safe to run every boot."""
